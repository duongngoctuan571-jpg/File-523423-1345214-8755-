...
local idplace = game.PlaceId

if idplace == 73956553001240 then
...
elseif idplace == 119579217517090 then
	loadstring(game:HttpGet("https://raw.githubusercontent.com/duongngoctuan571-jpg/hehe/refs/heads/main/dell-co-key"))()
elseif idplace == 16281300371 then 
